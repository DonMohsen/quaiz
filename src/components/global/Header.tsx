...
useEffect(() => {
  ...
  return (
    <header
      className={clsx(
        "font-main fixed z-[50] top-0 w-full h-[64px] max-sm:h-[56px] flex  items-center justify-between px-[100px]  text-white transition-all duration-300 max-md:px-[10px]",
        varient === "app"
          ? scrolled
